    ...
    <main className="min-h-screen bg-gradient-to-b from-[#1A1A1A] to-black text-white p-4 py-12">
      <div className="max-w-3xl mx-auto text-center">
        ...
        <p className="text-gray-400 mb-8">
          Te lo enviamos por email y WhatsApp. También puedes guardarlo aquí.
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          >
            ...
            href={`https://wa.me/?text=Compré%20mi%20ticket%20TSL!%20%F0%9F%8E%9F%EF%B8%8F%20https://tusorteolegal.cl/verificar/${uuid}`}
            target="_blank"
            rel="noopener"
